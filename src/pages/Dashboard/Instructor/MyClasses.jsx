...
const MyClasses = () => {
  ...
  useEffect(() => {
    axiosSecure
      .get(`/instructorclasses?email=${user.email}`)
  ...
  return (
    <div className="p-5">
      <h1 className="text-center text-2xl text-slate-500 mb-5 uppercase underline">
        My Classes: <span className="font-bold">{classes.length}</span>
      </h1>{" "}
            ...
            <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="px-5 pb-5">
                <a href="#">
                  ...
                  <p className="font-bold">{classItem.instructor}</p>
                  <p className="font-bold text-blue-600">
                    Enrolled:{classItem.students}
                  </p>
                  <p className="font-bold text-blue-600">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to={`/dashboard/updateclass/${classItem._id}`}
